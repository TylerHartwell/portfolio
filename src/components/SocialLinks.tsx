    ...
    <ul className="flex flex-col items-center gap-6  text-nowrap text-stone-300 ">
      <li>
        <a
          ...
          target="_blank"
          className="underline flex gap-2 items-center hover:translate-y-px transition-all group hover:text-yellow-200"
        >
      ...
      <li className="mt-3">
        <a
          ...
          className="flex gap-2 items-center hover:translate-y-px transition-all group hover:text-yellow-200"
        >
          Check out my Resume
          <FaArrowRight />
